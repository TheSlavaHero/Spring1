...
<html>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="all_groups" class="btn btn-default navbar-btn">All Groups</button></li>
                        </ul>
        ...
        <script>
            ...
            $('#all_groups').click(function(){
                window.location.href='/all_groups_page';
            });
        </script>
    </body>
</html>